...
from mcc_primebot_classes import PrimeRobot

pi = 3.1415926535897


class RobotSpeedSettings:
    def __init__(self, straight_speed:int, straight_accel:int, turn_speed:int, turn_accel:int):
        self.straight_speed = straight_speed
        self.straight_accel = straight_accel
        self.turn_speed = turn_speed
        self.turn_accel = turn_accel


class RemoteProgram:
    def __init__(self, func:callable, character:chr = "X", light_color:Color = Color.BLUE):
